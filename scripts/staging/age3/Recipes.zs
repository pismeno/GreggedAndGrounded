...
} as IItemStack[IItemDefinition];

for key, value in IronShulkers {
    Recipes.addShaped(stage, key.makeStack(0),[
    ...
    Recipes.addShaped(stage, key.makeStack(1),[
    ...
    Recipes.addShaped(stage, key.makeStack(2),[
    ...
    Recipes.addShaped(stage, key.makeStack(3),[
    ...
    Recipes.addShaped(stage, key.makeStack(4),[
...
Recipes.setPackageStage("mrtjp", ["zero", "one", "two", "three", "four", "five"]);
Recipes.setPackageStage("gregtech", ["zero", "one", "two", "three", "four", "five"]);
