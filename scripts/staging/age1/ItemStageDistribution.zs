...
for item in SetStageOne{
    mods.ItemStages.removeItemStage(item);
    mods.ItemStages.addItemStage("one", item);
    mods.recipestages.Recipes.setRecipeStage("one", item);
}

mods.recipestages.Recipes.setRecipeStage("one", "gregtech:soft_mallet_wood");
mods.recipestages.Recipes.setRecipeStage("one", "gregtech:hoe_flint");