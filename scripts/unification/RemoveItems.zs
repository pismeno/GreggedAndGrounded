...
mods.ItemStages.stageTooltip("five", "&eEMC");
mods.ItemStages.stageTooltip("five", "&eStack EMC");
...
for item in RemoveFromGame{
    ...
    //furnace.remove(item);
    //recipes.removeByInput(item);
}

mods.recipestages.Recipes.setPrintContainers(true);

ItemStages.stageModItems("removed", "microblockcbe");